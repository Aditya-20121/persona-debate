...
export default function DebateSetupForm({
  ...
  return (
    ...
    >
      <div>
        <h2 className="text-[11px] font-semibold uppercase tracking-[0.16em] text-muted mb-3">
          Debaters
        </h2>
            ...
            return (
              <motion.button
                ...
                className={`flex items-center gap-3 rounded-xl border px-3 py-3 text-left transition-colors ${
                  active
                    ? "border-white/25 bg-arena-raised"
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <select
            ...
            className="w-full rounded-xl bg-arena-raised border border-arena-border px-3.5 py-2.5 text-sm text-white focus:outline-none focus:border-white/40 transition-colors [&>option]:text-black"
          >
            {[1, 2, 3, 4, 5].map((n) => (
